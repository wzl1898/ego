    ...
    <el-container>
      <el-header height="20%">
        ...
        <div class="user_avatar">
          <img
            class="avatar"
            :src="`http://localhost:8080/common/download?name=` + user.userPtUrl"
            alt=""
      ...
      <el-container>
        ...
        <el-main>
          <div class="productBoxContainer">
            ...
            >
              ...
              <div class="detailBox">
                <div class="type">
                  <router-link :to="`/AdminProductDetail/${JSON.stringify(item)}`">{{
                    item.goodName
                  }}</router-link>
                </div>
        ...
        <el-aside width="17%">
          <el-menu class="el-menu-vertical-demo">
            ...
            <el-menu-item index="4" class="personal_item" @click="$router.push('/messageList')">
              <i
